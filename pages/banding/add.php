<?php if ( ! defined('FCPATH')) exit('No direct script access allowed');
	...
	if (isset($_POST['save']) AND trim(strtolower($_POST['save']))=="simpan") {
		$response = $banding_lib->form_validation();
		if ($response['status']==200) {
			$response = $banding_lib->stored_data();

			header('Location: '.$websiteConfig->base_url().'?route=banding&status='.$response['status'].'&message='.base64_encode($response['message']));
		}
	}
...
<div class="row">
	<div class="col-md-12">
		<h3 class="page-header">Tambah Data Banding</h3>
	</div>
</div>
<div class="row" style="<?php echo (isset($message) AND trim($message)!='')?'':'display: none;'; ?>">
	<div class="col-md-12">
		<div class="alert alert-<?php echo (isset($status) AND trim($status)==200)?'success':'warning'; ?>"><?php echo $message; ?></div>
	</div>
</div>
<div class="row">
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-body">
				<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Jarak Dengan Aset (m)</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Keterangan Penjual</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Frontage (m)</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Lebar Jalan Depan Aset (m)</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Lebar Jalan Masuk Aset (m)</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Luas Bangunan (m2)</label>
						<div class="col-sm-8">
